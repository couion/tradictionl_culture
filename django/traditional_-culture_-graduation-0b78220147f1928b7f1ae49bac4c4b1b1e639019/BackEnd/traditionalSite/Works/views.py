...
class WorksAPI(APIView):
    def get(self, request, *args, **kwargs):
        ...
        # 获取返回数据结构
        return JsonResponse(
            success_json_response("查询成功", paginator.get_paginated_response(get_message_by_works(page)).data))
...
class WorkMaxMarkQueryAPI(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        works_data.sort(key=lambda item: item['marks_count'], reverse=True)
