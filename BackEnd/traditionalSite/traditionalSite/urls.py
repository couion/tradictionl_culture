...
from Works.views import WorksAPI, WorkQueryAPI, operationForWorkByUserAPI, operationForCommentByUserAPI, \
    UserLikeListAPI, UserMarkListAPI, WorkMaxLikeQueryAPI, WorkMaxMarkQueryAPI
...
urlpatterns = [
    ...
    path("works/max/like", WorkMaxLikeQueryAPI.as_view(), name="点赞最高列表"),
    path("works/max/mark", WorkMaxMarkQueryAPI.as_view(), name="收藏最高列表"),
